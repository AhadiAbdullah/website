    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right ">
               <a href="{{route('user.register')}}" class="btn btn-sm btn-success">New</a>
            </ul>
            ...
            <table id="example" class="table table-striped  jambo_table">
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td><a onclick="return confirm('Are you sure you want to delete this item?');" href="{{ route('user.delete', $user->id) }}" class="btn btn-danger btn-sm">Delete</a></td>
                    </tr>
                @endforeach
                </tbody>
