...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            @endif
                <form method="post" action="{{ route('staff.store') }}" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>
                ...
                @csrf
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea id="details" required="required" name="details" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                    </div>
                    <div class="item form-group">
