...
<div class="item teaser-page-list">
			<div class="container_16">
				<aside class="grid_10">
					<h1 class="page-title">Upcomming Events</h1>
				</aside>
				<div class="grid_6">
					<div id="rootline">
					...
					<article class="list vevent">
						<div class="short-content">
							...
							<div class="entry-meta">
								<time class="dtstart" datetime="2018-04-25T19:02:42+00:00"><a class="buttons time fleft" href="#"><i class="fa fa-calendar " aria-hidden="true"></i>{{\Carbon\Carbon::parse($event->date)->format(' d M Y')}}</a></time> <a class="buttons facebook fleft" href="{{$event->social_link}}"><i class="fa fa-facebook-official" aria-hidden="true"></i> Facebook</a> <a class="buttons fright" href="{{$event->social_link}}" title="Join us">Join us</a>
							</div>
							<div class="clear"></div>
